...
public class PanCardDetailsType implements UserType {
	...
	public Object nullSafeGet(ResultSet rs, String[] names, SharedSessionContractImplementor session, Object owner)
		...
		try {
			...
			return objectMapper.readValue(cellContent.toString(), returnedClass());
		} catch (final Exception ex) {
			throw new RuntimeException("Faild To Convert String" + ex.getMessage(), ex);
		}
	}
